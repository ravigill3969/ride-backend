...
const (
	...
	AuthService_SendCookie_FullMethodName     = "/auth.AuthService/SendCookie"
...
type AuthServiceClient interface {
	...
	SendCookie(ctx context.Context, in *SendCookieRequest, opts ...grpc.CallOption) (*GenericResponse, error)
...
func (c *authServiceClient) SendCookie(ctx context.Context, in *SendCookieRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, AuthService_SendCookie_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetUserData(ctx context.Context, in *UserDataRequest, opts ...grpc.CallOption) (*UserDataResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	SendCookie(context.Context, *SendCookieRequest) (*GenericResponse, error)
...
func (UnimplementedAuthServiceServer) SendCookie(context.Context, *SendCookieRequest) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendCookie not implemented")
}
func (UnimplementedAuthServiceServer) GetUserData(context.Context, *UserDataRequest) (*UserDataResponse, error) {
...
func _AuthService_SendCookie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendCookieRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).SendCookie(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_SendCookie_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SendCookie(ctx, req.(*SendCookieRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuthService_GetUserData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserData(ctx, req.(*UserDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_SendCookie_Handler,
		},
		{
